        ...
        <div className="max-w-screen-xl mx-auto px-28 py-10 box-border gap-6">
            ...
            <div className="grid grid-cols-3 gap-8 ">
                <div className="max-w-[250px] text-center mx-auto">
                    <div className=" flex justify-center"><p className="border-4 p-4 box-content rounded-full"><FaSchool className="  h-[50px] w-[50px]   "></FaSchool></p></div>
                ...
                <div className="max-w-[250px] text-center mx-auto">
                    <div className=" flex justify-center"><p className="border-4 p-4 box-content rounded-full"><TbPackages className="  h-[50px] w-[50px]   "></TbPackages></p></div>
                ...
                <div className="max-w-[250px] text-center mx-auto">
                    <div className=" flex justify-center"><p className="border-4 p-4 box-content rounded-full"><GrDeliver className="  h-[50px] w-[50px]   "></GrDeliver></p></div>
                    <p className="text-[20px] font-thin">Our drivers deliver food directly to the schools’ front doors,  over 600kms per week</p>
                </div>
                <div className="max-w-[250px] text-center mx-auto">
                    <div className=" flex justify-center"><p className="border-4 p-4 box-content rounded-full"><GiHotMeal className="  h-[50px] w-[50px]   "></GiHotMeal></p></div>
                    <p className="text-[20px] font-thin">Over 7,500 meals or snacks per week are provided by schools with the food we provide</p>
                </div>
                <div className="max-w-[250px] text-center mx-auto">
                    <div className=" flex justify-center"><p className="border-4 p-4 box-content rounded-full"><PiStudentBold className="  h-[50px] w-[50px]   "></PiStudentBold></p></div>
                ...
                <div className="max-w-[250px] text-center mx-auto">
                    <div className=" flex justify-center"><p className="border-4 p-4 box-content rounded-full"><GiLovers className="  h-[50px] w-[50px]   "></GiLovers></p></div>
